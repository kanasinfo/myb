...
<div id="subHeader">
	<div class="wrapper">
        ...
        <ul id="subNavigator">
            ...
            <li><a href="${ctx}/page/managerWaring/managerSetUp/${id}.html" ${pageContext.request.servletPath=="/WEB-INF/views/jsp/managersetup/managerSetUp.jsp"?"class=\"current\"":""}>顾客管理</a></li>
        </ul>
    </div>
</div>