...
<jsp:include page="include/topsurveylist.jsp"/>
    <div class="wrapper">
        <div id="titleBar">
            ...
            <span id="titleTip" style="font-size: 12px;"><a
                    href="${ctx}/page/main/proreport/${id}.html">点击进入详细报告</a></span>
        </div>
        ...
        <div>
            <div class="rightColumn storeoverview">
                ...
                <div class="firstRowContent">
                    ...
                    <div style="height: 250px; position: relative; background-color: transparent;top:-55px"
                         class="storeCardChart"></div>
                </div>
            </div>
            <div class="leftColumnMain" id="overviewcard">
                ...
                <div class="firstRowContent">
                    <div class="summarynodata"
                         style="text-align:center; font-size: 16px; color: rgb(153, 153, 153); padding-top: 100px;">暂无数据
                    </div>
                    <div class="summarydata" style="display:none">
                        <div style="width:33%;float:left;" id="" class="firstColumn chart-main">
                            ...
                            <div style="height:110px">
                                <div style="position: relative; overflow: hidden; width: 196px; height: 210px; cursor: default;top:-70px"
                                     class="overviewTrend"></div>
                            </div>
                        </div>
                    ...
                    <div class="secondRowContent detailedItemDiv">
                        <table class="detailedItemTable" style="width:100%">
                            <tr>
                                <td width="125px;"></td>
                                <td>
                                    <div style="height:1px;width:100px;background-color:#ffffff"></div>
                                </td>
                            </tr>
                        </table>
                    </div>
