...
<head>
	...
	.middle-south{border-top:2px solid #f5f5f5;}
	.right-north,
	.right-south {
		background-color:white;
	}
...
<div class="outer-center">
						...
						<div class="title">总体顾客满意度</div>
							...
							<div class="comments">
								...
								<div class="commentscontent">
									1、从本次调查来看，有<span class="satisfied">xx%</span>的顾客对<span class="store">xx餐厅</span>表示满意（8-10分）， <span class="unsatisfied">xx%</span>的顾客表示不满意（1-5分），其余<span class="neutral">xx%</span>的顾客态度中立；<br> 2、与行业水平相比，<span class="store">xxx餐厅</span>的满意顾客占比<span class="comment-desc">&lt;插入判别描述&gt;</span>.
								</div>
							</div>	
						</div>					
					</div>
	...
	<div class="middle-north">
		...
		<div class="wsToolbar">
			<button class="myButton dimensions dropdown-toggle" id="dimnsnbutton" style="width:100px;float:left;">+细分维度</button>
			<ul class="dropdown-menu dimensions-dropdown" style="display:none; position:absolute;top:70px;background-color:#f5f5f5;width:320px" >
				...
				<li class="divider"></li>
				<li><button class="btn dimn-new" style="width:100%;padding:3px 12px;border:1px solid #c6e38e">+ 自定义维度</button></li>
				<li><button class="btn dimn-confirm" style="width:100%;padding:3px 12px;border:1px solid #c6e38e">确认</button></li>
			</ul>	
			<ul class="dimnsn">
				<li>
				<span>
...
<div class="outer-east">
	...
	<div class="right-center" style="background-color:white;">
	<img src="${ctx}/assets/screenshot/screenshot1.PNG" style="width:70px"></img>
	</div>
</div>
		...
		<div class="dimension-dialog">
		    ...
		    <div class="row ui-tabs ui-widget ui-widget-content ui-corner-all ui-tabs-vertical ui-helper-clearfix" id="dimension-tabs">
		        <div class="dimn-left-nav">
		            <ul class="dimn-sg-name">		                
		                <li><div class="newsmplbtn" onclick="newsamplegroup(this);" >+</div></li>
		...
		<div id="saveFilterNameDialog">
			<label for="filterName">名字</label><input type="text" name="filterName" id="filterName" class="text ui-widget-content ui-corner-all">
