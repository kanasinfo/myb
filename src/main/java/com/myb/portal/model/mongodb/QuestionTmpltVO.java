...
/**
 * <p>Title: QuestionVO</p>
 * <p>Description: (模板VO模型)</p>
 * <p>date : 2015年12月23日 下午10:52:43 </p>
 * @author wangzx
 * @version 1.0
 */
@Document(collection="qustnnr")
public class QuestionTmpltVO {
	//模板ID
	@Id
	private String id;
	private String qustnnrId;
	//模板ID
	...
	public String getQustnnrId() {
		return qustnnrId;
	}
	public void setQustnnrId(String qustnnrId) {
		this.qustnnrId = qustnnrId;
	}
