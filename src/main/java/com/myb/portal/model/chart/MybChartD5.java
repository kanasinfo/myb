...
public class MybChartD5 extends MybChart {
	...
	public AjaxReq getData(MongoTemplate mongoTemplate) {
		...
		try {
			...
			option.append("series : [{name:'直接访问',type:'line',stack: '总量',itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},data:[320, 302, 301, 334, 390, 330, 320]},");
			option.append("{name:'邮件营销',type:'line',stack: '总量',itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},data:[120, 132, 101, 134, 90, 230, 210]},");
			option.append("{name:'联盟广告',type:'line',stack: '总量',itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},data:[220, 182, 191, 234, 290, 330, 310]},");
			option.append("{name:'视频广告',type:'line',stack: '总量',itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},data:[150, 212, 201, 154, 190, 330, 410]},");
			option.append("{name:'搜索引擎',type:'line',stack: '总量',itemStyle : { normal: {label : {show: true, position: 'insideRight'}}},data:[820, 832, 901, 934, 1290, 1330, 1320]}]}");
