...
public class MybChartP80 extends MybChart{
	...
	public AjaxReq getData(MongoTemplate mongoTemplate) {
		...
		try {
			...
			option.append("legend: {data:['邮件营销','联盟广告','视频广告','直接访问','搜索引擎']},");
			option.append("toolbox: {show : true,feature : {mark : {show: true},dataView : {show: true, readOnly: false},magicType : {show: true, type: ['line', 'bar', 'stack', 'tiled']},");
			...
			option.append("series : [{name:'邮件营销',type:'line',stack: '总量',data:[120, 132, 101, 134, 90, 230, 210]},");
			option.append("{name:'联盟广告',type:'line',stack: '总量',data:[220, 182, 191, 234, 290, 330, 310]},");
			option.append("{name:'视频广告',type:'line',stack: '总量',data:[150, 232, 201, 154, 190, 330, 410]},");
			option.append("{name:'直接访问',type:'line',stack: '总量',data:[320, 332, 301, 334, 390, 330, 320]},");
			option.append("{name:'搜索引擎',type:'line',stack: '总量',data:[820, 932, 901, 934, 1290, 1330, 1320]}]}");
