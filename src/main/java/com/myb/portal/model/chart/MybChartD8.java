...
public class MybChartD8 extends MybChart{
	...
	public AjaxReq getData(MongoTemplate mongoTemplate) {
		...
		try {
			...
			option.append("saveAsImage : {show: true}}},calculable : true,legend: {data:['蒸发量','降水量','平均温度']},");
			option.append("xAxis : [{type : 'category',data : ['1月','2月','3月','4月','5月','6月','7月','8月','9月','10月','11月','12月']}],");
			option.append("yAxis : [{type : 'value',name : '水量',axisLabel : {formatter: '{value} ml'}},{type : 'value',name : '温度',axisLabel : {formatter: '{value} °C'}}],");
