...
public class MybProReportEchartController {
	...
	@ResponseBody
	public AjaxReq getChartAllInfo(@RequestParam(value="questionnaire_id", required=true) String questionnaireId,@RequestParam(value="group_id", required=false) String groupId,@RequestParam("question_id") String questionId,String page,String filter, @RequestParam("dimensiontype") String dimensionType, String dimension,@RequestParam(value="questionGroup", required=false) String questionGroup,@RequestParam(value="questionName", required=false) String questionName){
		System.out.println(questionnaireId);
		try {
			MybChart chart = (MybChart)Class.forName("com.myb.portal.model.chart.MybChart"+page.toUpperCase()).newInstance();
	...
	@ResponseBody
	public AjaxReq getChartSummaryInfo(@RequestParam(value="questionnaire_id", required=true) String questionnaireId,@RequestParam(value="groupId", required=false) String groupId,@RequestParam(value="question_id", required=false) String questionId,String page, String filter, @RequestParam(value="questionGroup", required=false) String questionGroup){
		System.out.println(questionnaireId);
		try {
			MybChart chart = (MybChart)Class.forName("com.myb.portal.model.chart.MybChart"+page.toUpperCase()).newInstance();
			chart.setFilter(filter);
